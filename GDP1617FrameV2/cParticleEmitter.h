...
public:
	...
	static const int DEFAULT_NUMBER_OF_PARTICLES = 100000;
	...
	CRITICAL_SECTION CSParticleUpdate;
	void Lock(void);
	void UnLock(void);
	bool bIsLocked(void);
private:
...
public:
	...
	// Thread will monitor and exit when this is false
...
private:
	...
	std::vector<cParticle> m_vecParticlesCOPY;
